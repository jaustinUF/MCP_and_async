...
from med_find_sync_bridge2 import MCP_ChatBot, start_async_loop
...
async def ask_query():
    ...
    '''# Append user query
    current_text = text_output.text
    text_output.text = f"{current_text}\nYou: {query}" if current_text else f"You: {query}"
'''
